...
Reviewed default revision `3fcff76488aa43c24d7b55a396397832bd380c83` and existing recovery/diagnostic candidate `84ce3bb53340bf5590c23e80efcca69d17eebfa7` (PR #7). All downloaded files were verified against the GitHub tree's blob hashes before testing. There is no AGENTS.md in either tree. The repository is a standalone Python diagnostic utility; it contains no Terraform resources or deployable application requiring cloud provisioning.
